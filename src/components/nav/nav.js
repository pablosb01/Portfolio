...
export default function LeftNav() {
  ...
  return (
    <div className="flex-row hidden lg:flex">
      <div className="sticky hidden lg:flex w-fit h-screen flex flex-col border-r-2 border-black dark:border-gray-600 transition-colors duration-300 bg-zinc-400 dark:bg-zinc-800">
        <div className="relative w-fit h-fit p-2">
          <div className="group relative flex justify-center items-center">
            <div className="absolute inset-0 flex justify-center items-center">
              <div className="w-48 h-48 bg-red-400 dark:bg-indigo-500 transition-colors duration-300 rounded-full transition-transform duration-300 ease-in-out transform group-hover:scale-90"></div>
            </div>
